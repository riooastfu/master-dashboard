...
import { PopmenuSchema, RotasiSchema } from "@/schemas"
...
export const RotasiModal = () => {
    ...
    const form = useForm<z.infer<typeof RotasiSchema>>({
        resolver: zodResolver(RotasiSchema),
        defaultValues: {
    ...
    const onSubmit = async (values: z.infer<typeof RotasiSchema>) => {
        try {
            ...
            if (updateStyles.rotasi) {
                await updateStyles.rotasi(
