...
interface DataTableProps {
    ...
    data: ActivityProps[]
    onEdit: (record: ActivityProps) => void
...
export function DataTable({
    ...
    const handleDeleteClick = (activityId: number, activityName: string) => {
        setDeleteDialog({
            isOpen: true,
            activityId,
            activityName
    ...
    const handleDeleteConfirm = () => {
        if (deleteDialog.activityId) {
            onDelete(deleteDialog.activityId)
        }
    ...
    const table = useReactTable({
        ...
        meta: {
            onEdit,
            onDelete: (activityId: number, activityName: string) => handleDeleteClick(activityId, activityName),
        } as DataTableMeta,
    })
